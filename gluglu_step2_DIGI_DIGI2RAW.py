...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:GluGluTo2Jets_M_300_2000_13TeV_exhume_cff_py_GEN_SIM_HECTOR_CTPPS.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = process.FEVTDEBUGHLTEventContent.outputCommands+['keep *_RPixDetDigitizer_*_*','keep *_ctppsPixelRawData_*_*'], 
